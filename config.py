...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7223199796:AAHFmYjUpW8UUc_HCdC-CVGrGmvQDp3MWJM")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6955387260 7328629001 7148126384 ").split()):
        ADMINS.append(int(x))
except ValueError:
