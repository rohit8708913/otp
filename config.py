...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7223199796:AAFPS7v8m3Uqe4d75gzR8ICGI5BP8CF4uiM")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", " <b> {filename} • ʙʏ @rohit_1888</b>")
